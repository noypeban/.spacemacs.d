...
values."
  ...
  (setq-default
   ...
   ;; The leader key
   dotspacemacs-leader-key "<kanji>"
   ;; The leader key accessible in `emacs state' and `insert state'
   ;; (default "M-m")
   dotspacemacs-emacs-leader-key "<kanji>"
   ;; Major mode leader key is a shortcut key which is the equivalent of
   ;; pressing `<leader> m`. Set it to `nil` to disable it. (default ",")
   dotspacemacs-major-mode-leader-key "C-c"
...
`dotspacemacs/user-config' first."
  ;; Configrations with each environment.
  (let ((custom-file "~/.spacemacs.d/custom.el"))
...
you should place you code here."
  ...
  ;;set powerline separator to avoid "invalid image type xpm" error
  ...
  (with-eval-after-load 'org
    ...
    (let ((lst '("u" "UnScheduled TODO"
      ...
      (if (boundp 'org-agenda-custom-commands)
          (add-to-list 'org-agenda-custom-commands lst t)
        (setq org-agenda-custom-commands (list lst)))))
